...
protocol ProfileService {
    ...
    func updateProfile(_ profile: ProfileEntity, completion: @escaping ProfileCompletion)
}
...
final class ProfileServiceImpl: ProfileService {
    ...
    func loadProfile(id: String, completion: @escaping ProfileCompletion) {
        ...
        networkClient.send(request: request, type: ProfileEntity.self) { [weak storage] result in
            switch result {
